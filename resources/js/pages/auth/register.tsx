            ...
            <main className="flex-1 px-6 pt-12">
                ...
                <div className="flex flex-col gap-3">
                    <a
                        ...
                        target="_self"
                        rel="noopener"
                        className="flex items-center justify-center gap-3 h-12 border border-border rounded-xl hover:bg-secondary/50 transition-colors"
                    >
                        ...
                        <span className="text-sm font-medium">{t('auth.continue_with_google')}</span>
                    </a>
                    <a
                    ...
                    >
                        ...
                        <span className="text-sm font-medium">{t('auth.continue_with_facebook')}</span>
                    </a>
                </div>
